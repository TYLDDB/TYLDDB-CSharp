...
{
    internal class Read_C_MinGW : IDisposable
    {
        ...
        [DllImport("libs/mingw/libReadFile.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        private static extern int open_mapped_file(
            [MarshalAs(UnmanagedType.LPWStr)] string filePath,
            out MappedFileResult result);

        [DllImport("libs/mingw/libReadFile.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        {
            if (_disposed) throw new ObjectDisposedException(nameof(Read_C_MinGW));
            Close();
